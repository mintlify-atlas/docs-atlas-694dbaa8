...
These parameters are defined in `runner.hpp:53-63` but not currently exposed as environment variables:

- `repeat_last_n`: `64` - Number of recent tokens to consider for repeat penalty
